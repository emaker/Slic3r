...
our @EXPORT_OK = qw(EXTR_ROLE_PERIMETER EXTR_ROLE_EXTERNAL_PERIMETER 
    ...
    EXTR_ROLE_SUPPORTMATERIAL EXTR_ROLE_HOLE EXTR_ROLE_GAPFILL);
...
has 'polyline' => (
    is          => 'rw',
    required    => 1,
    handles     => [qw(merge_continuous_lines lines length reverse clip_end clip_start simplify)],
);
...
use constant EXTR_ROLE_HOLE                         => 11;
